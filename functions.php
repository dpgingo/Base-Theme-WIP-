...
wp_register_style('main-style', get_template_directory_uri() . '/dist/styles/main.css');
wp_enqueue_style('main-style');

wp_register_script('main-script', get_template_directory_uri() . '/dist/scripts/main.js');
